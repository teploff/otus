...
// endpoint.
type RequestFunc func(context.Context, *stan.Msg) context.Context
...
type SubscriberResponseFunc func(context.Context, *stan.Conn) context.Context

// PublisherResponseFunc may take information from an NATS Streaming request and make the
...
type PublisherResponseFunc func(context.Context, *stan.Msg) context.Context
